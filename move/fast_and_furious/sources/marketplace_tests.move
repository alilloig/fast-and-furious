...
fun admin_can_update_fee() {
    ...
    marketplace::update_fee(&admin_cap, &mut config, 500);
...
fun update_fee_rejects_excessive_fee() {
    ...
    marketplace::update_fee(&admin_cap, &mut config, 10_001);
    abort 0
}
...
fun update_fee_allows_max_fee() {
    ...
    marketplace::update_fee(&admin_cap, &mut config, 10_000);
...
fun admin_can_update_fee_recipient() {
    ...
    marketplace::update_fee_recipient(&admin_cap, &mut config, test_utils::user1());
